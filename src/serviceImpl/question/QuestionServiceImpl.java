...
public class QuestionServiceImpl implements QuestionService {
    public static Logger loggerForQuestion = Logger.getLogger("QuizQuestionLogger");
    ...
    public Question create(Object object) {
        ...
        loggerForQuestion.info("'%s' question successfully creating\n'%s'".formatted(question, userService.getSessionUser()));
        return question;
    }
    ...
    public Question update(String id) {
        ...
        if (Objects.nonNull(question)) {
            ...
            loggerForQuestion.info("'%s' question successfully updated".formatted(question));
    ...
    public Question delete(String id) {
        ...
        if (Objects.nonNull(question)) {
            ...
            loggerForQuestion.info("'%s' question successfully deleted".formatted(question));
